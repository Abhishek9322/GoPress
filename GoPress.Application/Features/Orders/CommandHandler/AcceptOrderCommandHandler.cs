...
{
    public class AcceptOrderCommandHandler : IRequestHandler<AcceptOrderCommand, Response<string>>
    {
        ...
        public async Task<Response<string>> Handle(AcceptOrderCommand request, CancellationToken cancellationToken)
        {
