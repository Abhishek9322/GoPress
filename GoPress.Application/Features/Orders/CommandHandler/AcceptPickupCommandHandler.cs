...
{
    public class AcceptPickupCommandHandler : IRequestHandler<AcceptPickupCommand, Response<string>>
    {
        private readonly IOrderRepository _orderRepository;
        public AcceptPickupCommandHandler(IOrderRepository orderRepository)
        {
            _orderRepository = orderRepository;
        }
        public async Task<Response<string>> Handle(AcceptPickupCommand request, CancellationToken cancellationToken)
        {
