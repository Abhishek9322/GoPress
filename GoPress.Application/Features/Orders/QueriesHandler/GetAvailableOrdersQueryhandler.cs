...
{
    public class GetAvailableOrdersQueryhandler : IRequestHandler<GetAvailableOrdersQuery, Response<List<AvailableOrderDto>>>
    {
        ...
        public async Task<Response<List<AvailableOrderDto>>> Handle(GetAvailableOrdersQuery request, CancellationToken cancellationToken)
        {
